...
const carotidSinusReflexData = {
    id: 1,
    stars: 17,
    name: 'Carotid Sinus Reflex',
    authors: ['Eric Yates'],
    conditions: [],
    lastUpdated: 'April 3rd, 2023',
    nodes: [
        {
            id: '1',
            data: {label: 'Baroreceptors'},
            position: {x: 250, y: 0},
            style: {height: 55, lineHeight: 2.5},
            children: [],
        },
        {
            id: '2',
            data: {label: 'Carotid Sinus'},
        ...
        {
            id: '3',
            data: {label: 'Glossopharyngeal Nerve'},
        ...
        {
            id: '6',
            data: {label: 'Caudal Ventrolateral Medulla'},
        ...
        {
            id: '7',
            data: {label: 'Rostral Ventrolateral Medulla'},
        ...
        {
            id: '8',
            data: {label: 'Intermediolateral Column'},
        ...
        {
            id: '10',
            data: {label: 'Dorsal Nucleus of Vagus Nerve'},
            position: {x: 50, y: 400},
            style: {height: 55},
            children: [],
        },
        ...
        },
        {
            ...
            style: {height: 55, borderRadius: 50, lineHeight: 2.5},
            children: [],
        },
        {
            id: '14',
            data: {label: '↑ Parasympathetic'},
            position: {x: 50, y: 700},
            style: {height: 55, borderRadius: 50, lineHeight: 2.5},
            children: [],
        },
    ...
    edges: [
        {id: 'e1-2', source: '1', target: '2', animated: true, style: {stroke: 'green'},},
        {id: 'e2-3', source: '2', target: '3', animated: true, style: {stroke: 'green'},},
        {id: 'e3-4', source: '3', target: '4', animated: true, style: {stroke: 'green'},},
        {id: 'e4-6', source: '4', target: '6', animated: true, style: {stroke: 'green'},},
        {id: 'e4-9', source: '4', target: '9', animated: true, style: {stroke: 'green'},},
        {id: 'e4-10', source: '4', target: '10', animated: true, style: {stroke: 'green'},},
        {id: 'e6-7', source: '6', target: '7', animated: true, style: {stroke: 'red'},},
        {id: 'e7-8', source: '7', target: '8', animated: true, style: {stroke: 'green'},},
        {id: 'e8-15', source: '8', target: '15', animated: false, style: {stroke: 'lightgray'},},
        {id: 'e9-11', source: '9', target: '11', animated: true, style: {stroke: 'green'},},
        {id: 'e10-12', source: '10', target: '12', animated: true, style: {stroke: 'green'},},
        {id: 'e11-13', source: '11', target: '13', animated: false, style: {stroke: 'lightgray'},},
        {id: 'e12-14', source: '12', target: '14', animated: false, style: {stroke: 'lightgray'},},
