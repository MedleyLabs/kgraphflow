    ...
    return (
        <>
            ...
            <div className='sidebar-body'>
                ...
                <SidebarSection title='Cell Types' description={props.header === 'Primary motor cortex' ? props.content.cellTypes : null} defaultIsOpen={true} style={props.header === 'Primary motor cortex' ? {height: 553} : {}}/>
